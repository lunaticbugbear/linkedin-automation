...
from scripts.generate_project_repo import create_github_repo, format_repo_name, push_readme_to_repo
...
def run_cycle():
    ...
    readme_content = f"""# {selected_project['title']}
...
## Use Case
{selected_project['use_case']}

## Tech Stack
{selected_project['tech_stack']}

## Key Features
{chr(10).join(f"- {feature}" for feature in selected_project.get('key_features', []))}
...
## LinkedIn Post
{selected_project['linkedin_post']}

---
Generated by LinkedIn Automation
"""

    push_readme_to_repo(repo_name, readme_content, config["github"]["token"])
